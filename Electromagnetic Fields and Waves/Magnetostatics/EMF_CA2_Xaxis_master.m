...
H_X_vect = sum(H_vector_components(:,1)); % norm of H vetorial componets
H_Y_vect = sum(H_vector_components(:,2)); % norm of H vetorial componets
H_Z_vect = sum(H_vector_components(:,3)); % norm of H vetorial componets

H_buff = sqrt(H_X_vect^2+H_Y_vect^2+H_Z_vect^2);

H_X_Y_Z_NORM = [H_X_Y_Z_NORM; H_X_vect H_Y_vect H_Z_vect H_buff];
end
H_X_Y_Z_NORM(1, :) = [];
